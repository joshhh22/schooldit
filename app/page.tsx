...
export default function HomePage() {
  ...
  return (
    <div className="space-y-4 font-sans">
      {/* Active Community Banner (if filtered by community) */}
      {activeSchoolObj && (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  s/{activeSchoolObj.slug} {activeSchoolObj.category ? `• ${activeSchoolObj.category}` : ''}
                </p>
              </div>
            </div>
            <Link
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 max-w-md mx-auto leading-relaxed font-sans">
                {searchQuery
                  ...
                  : 'Forum masih bersih. Jadilah orang pertama yang membuat postingan, spill cerita, atau daftarkan komunitas favoritmu!'}
              </p>
            </div>
